...
// ---------------------------------------------------------------------------
// NEW CODE IN THIS BLOCK
$order_query = new OrderQueryBatch();
$order_ids = array('DEMO-0009104390', 'DEMO-0009104391', 'DEMO-0009104392');
$order_query->setOrderIds($order_ids);

$orders_response = $order_api->getOrdersBatch($order_query, $order_expansion);
// ---------------------------------------------------------------------------
